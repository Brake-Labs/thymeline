  ...
  return rawRecipes
    ...
    .map((r) => {
      ...
      return {
        ...
        prep_time_minutes:     typeof r['prepTime'] === 'string' ? parseDuration(r['prepTime']) : null,
        cook_time_minutes:     typeof r['cookTime'] === 'string' ? parseDuration(r['cookTime']) : null,
        total_time_minutes:    typeof r['totalTime'] === 'string' ? parseDuration(r['totalTime']) : null,
