...
export default function PlanWeekError({ error: _error, reset }: { error: Error; reset: () => void }) {
    ...
    <div className="min-h-screen bg-stone-50 flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-stone-500 font-sans text-sm mb-6">
          We couldn&#39;t load your meal plan for this week. Let&#39;s try that again.
        </p>
        <button
        ...
        <div className="mt-4">
          <a href="/plan" className="text-stone-400 text-sm hover:text-stone-500 transition-colors">
            Back to planner
          </a>
        </div>
      </div>
