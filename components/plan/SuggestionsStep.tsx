      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="text-sm font-medium bg-sage-500 text-white px-4 py-2 rounded-lg hover:bg-sage-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            Confirm Plan
          </button>
        </div>
