...
export default function SuggestionMealSlotRow({
  ...
  return (
    <div className="border border-stone-100 rounded-lg overflow-hidden mb-2 last:mb-0">
            ...
            <div className="px-3 py-2 border-t border-stone-50">
              {dessertEntry ? (
                <div className="flex items-center gap-2 pl-4">
                  ...
                  <button onClick={() => { setDessertEntry(null); onDessertRemove?.(date, mealType) }} aria-label="Remove dessert" className="text-stone-300 hover:text-red-400 transition-colors text-base leading-none">×</button>
                </div>
              ) : (
      ...
      {dessertVaultOpen && (
        <VaultSearchSheet forDate={date} mealType="dessert"
          onAssign={(recipe) => { setDessertEntry(recipe); onDessertPick?.(date, mealType, recipe); setDessertVaultOpen(false) }}
