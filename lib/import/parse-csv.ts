...
export function parseCsv(
  ...
  for (let i = 1; i < rows.length; i++) {
    ...
    const recipe: ParsedRecipe = {
      ...
      url:                   get('url') || null,
      image_url:             null,
      prep_time_minutes:     parseTimeMinutes(get('prep_time_minutes')),
      cook_time_minutes:     parseTimeMinutes(get('cook_time_minutes')),
      total_time_minutes:    parseTimeMinutes(get('total_time_minutes')),
