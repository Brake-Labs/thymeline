    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <input
          ...
          className="w-full border border-stone-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-sage-500"
        />
      ...
      <div>
        ...
        <select
          ...
          className="w-full border border-stone-300 rounded px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-sage-500"
        >
        ...
        {(
          ...
          <div key={field}>
            ...
            <input
              ...
              className="w-full border border-stone-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-sage-500"
            />
            <p className="mt-0.5 text-xs text-stone-400">Enter time in minutes</p>
          </div>
        ))}
        <div>
          ...
          <input
            ...
            className="w-full border border-stone-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-sage-500"
          />
          <p className="mt-0.5 text-xs text-stone-400">Number of servings this recipe makes</p>
        </div>
      </div>
      ...
      {/* Steps */}
      <div>
        <label className="block text-sm font-medium text-stone-700 mb-1">Steps</label>
        <textarea
          value={values.steps}
